...
def plot_program_architecture(program_code, output_filename):
    with tempfile.TemporaryDirectory() as temp_dir:
        program_file = os.path.join(temp_dir, 'gnss_logs_visualization.py')
...
output_filename = "gnss_logs_visualization_architecture.svg"
plot_program_architecture(program_code, output_filename)
